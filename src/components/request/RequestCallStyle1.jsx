...
const RequestCallStyle1 = () => {
    return (
        <>
            <div className="request-call-back-area text-light default-padding" style={{ backgroundImage: `url(/assets/img/banner/1.webp)` }}>
                <div className="container">
                    <div className="row align-center">
                        <div className="col-lg-6">
                            <h2 className="title">Design + Build + Install</h2>

                        ...
                        <div className="py-12 text-center">
                            <div className="max-w-2xl mx-auto mb-8">
                                ...
                                <div className="text-blueGray-400 leading-relaxed wow animate__animated animate__fadeIn">
                                    We are <strong className="text-blue-500">Nexora</strong>, a Creative Design{" "}
                                    <div className="typewrite d-inline text-brand">
                                        <TextEffect text1="Web Development" text2="Social Marketing" text3="Graphic Design" text4="Video Editing" />
                                    </div>
                                </div>
                            </div>
                            <div>
                            ...
                            <div className="flex flex-wrap lg:max-w-sm mx-auto">
                                <div className="hover-up-5 w-1/2 md:w-1/3 lg:w-full mb-4 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                                    <div className="pt-10 pb-8 px-6 bg-white text-center rounded shadow border border-gray-100">
                                        ...
                                        <p className="text-sm text-blueGray-400 leading-loose">Discover innovative solutions tailored to elevate your business and inspire impactful results.</p>
                                    </div>
                                </div>
                                <div className="hover-up-5 w-1/2 md:w-1/3 lg:w-full wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                    <div className="pt-10 pb-8 px-6 bg-white text-center rounded shadow border border-gray-100">
                                        ...
                                        <p className="text-sm text-blueGray-400 leading-loose">Kickstart your projects with precision and expertise to build a strong foundation for success.</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="lg:pl-16">
                                    ...
                                    <div className="flex items-start py-4 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-blueGray-400 leading-loose">Grow your audience and strengthen connections with powerful tools and strategies.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start py-4 wow animate__animated animate__fadeIn" data-wow-delay=".7s">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-blueGray-400 leading-loose">Achieve consistent progress with solutions designed to drive sustainable business growth.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start py-4 wow animate__animated animate__fadeIn" data-wow-delay=".9s">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-blueGray-400 leading-loose">Streamline service bookings effortlessly with our user-friendly platform for maximum convenience.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="container">
                        <div className="flex flex-wrap items-center justify-between max-w-2xl lg:max-w-full mb-12">
                            ...
                            <div className="w-full lg:w-1/2">
                                <p className="text-blueGray-400 leading-loose wow animate__animated animate__fadeIn">At Nexora, we bring your digital goals to life. From building websites to crafting software, designing visuals, and managing social media, we’re your go-to partner for all things digital. Let’s make your business dreams a reality!</p>
                            </div>
                        </div>
                        <div className="flex flex-wrap -mx-3 -mb-6 text-center">
                            <div className="hover-up-5 w-full md:w-1/2 lg:w-1/3 px-3 mb-6 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                                <div className="p-12 bg-white shadow rounded">
                                    ...
                                    <p className="text-sm text-blueGray-400 leading-relaxed">Every great project begins with understanding your goals to craft a roadmap for success.</p>
                                </div>
                            </div>
                            <div className="hover-up-5 w-full md:w-1/2 lg:w-1/3 px-3 mb-6 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                <div className="p-12 bg-white shadow rounded">
                                    ...
                                    <p className="text-sm text-blueGray-400 leading-relaxed">We meticulously plan every detail, ensuring your project stays organized, efficient, and aligned with your vision.</p>
                                </div>
                            </div>
                            <div className="hover-up-5 w-full lg:w-1/3 px-3 mb-6">
                                <div className="p-12 bg-white shadow rounded wow animate__animated animate__fadeIn" data-wow-delay=".7s">
                                    ...
                                    <p className="text-sm text-blueGray-400 leading-relaxed">Our team ensures your project stays on track, tackling challenges and delivering exceptional results.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container">
                        ...
                        <div className="flex flex-wrap -mx-3 mb-6">
                            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                                <div className="border border-gray-100 pt-8 px-6 pb-6 bg-white h-full text-center rounded shadow hover:shadow-lg hover-up-2 transition duration-500 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                                    <div className="text-blue-500 mx-auto mb-4">
                                        <svg className="w-8 h-8 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className="text-sm text-blueGray-400">Empowering businesses with tailored IT solutions, we bridge the gap between challenges and opportunities to drive innovation and growth.</p>
                                </div>
                            </div>
                            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                                <div className="border border-gray-100 pt-8 px-6 pb-6 bg-white h-full text-center rounded shadow hover:shadow-lg hover-up-2 transition duration-500 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                    <div className="text-blue-500 mx-auto mb-4">
                                        <svg className="w-8 h-8 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className="text-sm text-blueGray-400">We craft visually stunning, user-friendly websites that elevate your online presence and create meaningful customer interactions.</p>
                                </div>
                            </div>
                            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                                <div className="border border-gray-100 pt-8 px-6 pb-6 bg-white h-full text-center rounded shadow hover:shadow-lg hover-up-2 transition duration-500 wow animate__animated animate__fadeIn" data-wow-delay=".7s">
                                    <div className="text-blue-500 mx-auto mb-4">
                                        <svg className="w-8 h-8 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className="text-sm text-blueGray-400">Transforming ideas into functional, engaging mobile apps designed to enhance user experience and business efficiency.</p>
                                </div>
                            </div>
                            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-8">
                                <div className="border border-gray-100 pt-8 px-6 pb-6 bg-white h-full text-center rounded shadow hover:shadow-lg hover-up-2 transition duration-500 wow animate__animated animate__fadeIn" data-wow-delay=".9s">
                                    <div className="text-blue-500 mx-auto mb-4">
                                        <svg className="w-8 h-8 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className="text-sm text-blueGray-400">Boost your brand's visibility with strategic campaigns that connect with your audience and achieve impactful results.</p>
                                </div>
                            </div>
                            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                                <div className="border border-gray-100 pt-8 px-6 pb-6 bg-white h-full text-center rounded shadow hover:shadow-lg hover-up-2 transition duration-500 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                                    ...
                                    <p className="text-sm text-blueGray-400">Offering innovative, data-driven solutions tailored to solve your business challenges and achieve lasting success.</p>
                                </div>
                            </div>
                            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                                <div className="border border-gray-100 pt-8 px-6 pb-6 bg-white h-full text-center rounded shadow hover:shadow-lg hover-up-2 transition duration-500 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                    ...
                                    <p className="text-sm text-blueGray-400">Designing adaptable websites that deliver seamless user experiences across all devices and platforms.</p>
                                </div>
                            </div>
                            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                                <div className="border border-gray-100 pt-8 px-6 pb-6 bg-white h-full text-center rounded shadow hover:shadow-lg hover-up-2 transition duration-500 wow animate__animated animate__fadeIn" data-wow-delay=".7s">
                                    ...
                                    <p className="text-sm text-blueGray-400">Creating minimalist, aesthetically pleasing designs that effectively communicate your brand’s identity and message.</p>
                                </div>
                            </div>
                            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                                <div className="border border-gray-100 pt-8 px-6 pb-6 bg-white h-full text-center rounded shadow hover:shadow-lg hover-up-2 transition duration-500 wow animate__animated animate__fadeIn" data-wow-delay=".9s">
                                    ...
                                    <p className="text-sm text-blueGray-400">Analyzing processes to identify opportunities for improvement, ensuring optimal efficiency and innovative outcomes.</p>
                                </div>
                            </div>
                        </div>
                    </div>

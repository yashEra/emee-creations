        ...
        <section className="pt-12">
          <div className="container py-12 mx-auto">
            <div className="flex flex-wrap">
              <div
                className="w-full md:w-1/2 pr-12 px-3 order-0 md:order-0 mb-12 md:mb-0 wow animate__animated animate__fadeIn flex items-center"
                data-wow-delay=".5s"
              >
                <img
              ...
              <div className="w-full md:w-1/2 px-3 order-1 md:order-1">
                <div className="max-w-md-2">
                  ...
                  <div className="flex flex-wrap">
                    <div
                      className="w-full md:w-1/2 items-start pt-4 pb-8 wow animate__animated animate__fadeIn p-4"
                      data-wow-delay=".2s"
                    >
                      ...
                      <div>
                        ...
                        <p className="text-blueGray-400 leading-loose text-sm">
                          We create visually stunning and user-friendly
                          websites. Our focus is on responsive designs,
                          intuitive user interfaces, and seamless experiences,
                          ensuring your website stands out while being easy to
                          navigate.
                        </p>
                      </div>
                    </div>
                    <div
                      className="w-full md:w-1/2 items-start py-4 wow animate__animated animate__fadeIn p-4"
                      data-wow-delay=".3s"
                    >
                      <div className="w-8 mb-5 text-blue-500">
                        <span className="inline-block py-2 px-4 mr-4 text-xs font-semibold bg-blue-500 text-white rounded">
                      ...
                      <div>
                        ...
                        <p className="text-blueGray-400 leading-loose text-sm">
                          Our React development services build dynamic, fast,
                          and interactive web applications. We focus on creating
                          responsive solutions with high performance and
                          scalability, tailored to meet the needs of your users.
                        </p>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-blueGray-400 leading-loose text-sm">
                          We specialize in custom WordPress websites. From theme
                          customization to plugin integration, we ensure your
                          website is responsive, SEO-friendly, and easy to
                          manage, providing a scalable platform for your
                          business.
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-blueGray-400 leading-loose text-sm">
                          We provide comprehensive e-commerce solutions. From
                          product catalog to secure payment systems, we ensure a
                          seamless shopping experience, helping to increase
                          conversion rates and support business growth.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
                ...
                >
                  ...
                  <h3 className="mb-2 text-3xl font-bold font-heading">
                    WordPress Developnet
                  </h3>
                  <span className="text-2xl text-blue-500 font-bold font-heading p-4">
                    Starting at 20,000 LKR
                  </span>

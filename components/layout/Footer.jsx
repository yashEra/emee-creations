                ...
                <div className="container px-4 mx-auto wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                    <div className="flex flex-wrap mb-12 lg:mb-20 -mx-3 text-center lg:text-left">
                        ...
                        <div className="w-full lg:w-1/5 px-3 mb-8 lg:mb-0">
                            ...
                            <p className="lg:text-lg text-blueGray-400">Colombo, Maharagama, Sri Lanka</p>
                        </div>
                        <div className="w-full lg:w-1/5 px-3">
                            <p className="mb-2 lg:mb-4 lg:text-lg font-bold font-heading text-blueGray-800">Contacts</p>
                            <p className="lg:text-lg text-blueGray-400">+94 71 764 4169</p>
                            <p className="lg:text-lg text-blueGray-400">+94 76 528 9313</p>
                            <p className="lg:text-lg text-blueGray-400">contact@nexora.com</p>
                        </div>
                    </div>
